extends SceneTree
## Χτίζει τις λωρίδες του πλαισίου από ξεχωριστά κομμάτια 64x64.
##
...
## palisade με σιδερένιες ζώνες· πάνω πέτρινο παραπέτο. Κάτω δεν μπαίνει
## τίποτα: η ζώνη του δράκου είναι συνέχεια του εδάφους της πίστας.
##
## Μόνο τα ΑΚΙΝΗΤΑ στολίδια ψήνονται μέσα στις πλαϊνές λωρίδες. Οι δάδες και
## το λάβαρο κινούνται, οπότε τα βάζει από πάνω το _draw_torches() του main —
## αν ψήνονταν κι αυτά εδώ, θα φαινόταν μια παγωμένη κόπια κάτω από την κίνηση.
...
# Δάδες και λάβαρο ΔΕΝ είναι εδώ: κινούνται, οπότε τα σχεδιάζει το
# _draw_torches() του main από πάνω, στις σειρές 2, 5 και 8. Ψημένα εδώ θα
# έμεναν παγωμένα κάτω από την κίνηση. Το κρανίο δεν κουνιέται και μένει.
const DECOR := [
	["deco_skull", 11, 8],
]
