extends SceneTree
## Χτίζει το art/background.png από τα 16 πλακίδια art/floor_*.png.
##
...
const WEIGHTS := {
	 1: 8,    # γρασίδι με μπαλώματα χώματος — η βάση
	 2: 8,
	 3: 8,
	 4: 6,
	 5: 2,    # λάσπη με πατημασιές — σκουραίνει, λίγη
	 6: 2,
	 7: 2,
	 8: 2,
	 9: 3,    # γρασίδι με βότσαλα
	10: 3,
	11: 4,
	12: 3,
